...
export class LectureStudentCountRepository {
  ...
  public async getStudentCount(
    ...
    const selectQuery: string = 'SELECT count FROM lecture_student_counts WHERE lecture_id = ?';
  ...
  public async delete(
    ...
    const deleteQuery: string = 'DELETE FROM lecture_student_counts WHERE lecture_id = ?'
