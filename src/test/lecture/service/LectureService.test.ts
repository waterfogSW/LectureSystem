...
import { LectureRepository } from '../../../main/lecture/repository/LectureRepository';
...
describe('LectureService', () => {
  ...
  describe('findAll', () => {
    ...
    it('[Success] Lecture의 목록조회를 요청한다.', async () => {
      ...
      const expected: Array<LectureListResponseItem> = [
        new LectureListResponseItem(1, LectureCategory.APP, 'title1', '감자', 10000, 10000, new Date()),
        new LectureListResponseItem(2, LectureCategory.ALGORITHM, 'title2', '고구마', 2000, 10000, new Date()),
      ];
      ...
      // when
      const actual: [Array<LectureListResponseItem>, number] = await sut.findAll(request, connection);
