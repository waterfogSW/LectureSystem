...
import { LectureService } from '../../../main/lecture/service/LectureService';
...
import { LectureListResponse } from '../../../main/lecture/controller/dto/LectureListResponse';
import { LectureListRequest } from '../../../main/lecture/controller/dto/LectureListRequest';
import { LectureBulkCreateResponse } from '../../../main/lecture/controller/dto/LectureBulkCreateResponse';
import { LectureBulkCreateRequest } from '../../../main/lecture/controller/dto/LectureBulkCreateRequest';
...
import { LectureDeleteRequest } from '../../../main/lecture/controller/dto/LectureDeleteRequest';
import { LectureDetailRequest } from '../../../main/lecture/controller/dto/LectureDetailRequest';
import { LectureDetailResponse } from '../../../main/lecture/controller/dto/LectureDetailResponse';
import { Student } from '../../../main/student/domain/Student';
import { TestStudentFactory } from '../../util/TestStudentFactory';
import { LecturePublishRequest } from '../../../main/lecture/controller/dto/LecturePublishRequest';
import { IllegalArgumentException } from '../../../main/common/exception/IllegalArgumentException';
import { LectureListResponseItem } from '../../../main/lecture/controller/dto/LectureListResponseItem';
...
describe('LectureFacade', () => {
  ...
  describe('listLecture', () => {
    it('[Success] 강의 목록을 요청하고 응답을 반환한다.', async () => {
      ...
      const lectureItem: LectureListResponseItem = LectureListResponseItem.of(1, 'web', '강사명', '강사명', 1, 1, new Date().toString());
